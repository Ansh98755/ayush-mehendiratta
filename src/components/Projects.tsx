...
export const projects: Project[] = [
  {
    ...
    image: '/lovable-uploads/furrvy-9.webp',
  ...
  { type: 'image', url: '/lovable-uploads/furrvy-6.webp' },
  { type: 'image', url: '/lovable-uploads/furrvy-5.webp' },
  { type: 'image', url: '/lovable-uploads/furrvy-4.webp' },
  { type: 'image', url: '/lovable-uploads/furrvy-3.webp' },
  { type: 'image', url: '/lovable-uploads/furrvy-2.webp' },
  ],
  },
  {
    title: 'Niti App',
  ...
  { type: 'image', url: '/lovable-uploads/niti-3.webp' },
  { type: 'image', url: '/lovable-uploads/niti-4.webp' },
  { type: 'image', url: '/lovable-uploads/niti-5.webp' },
  { type: 'image', url: '/lovable-uploads/niti-6.webp' },
  { type: 'image', url: '/lovable-uploads/niti-7.webp' },
  { type: 'image', url: '/lovable-uploads/niti-8.webp' },
  { type: 'image', url: '/lovable-uploads/niti-9.webp' },
  { type: 'image', url: '/lovable-uploads/niti-10.webp' },
  ]
  },
  {
    title: 'DoStartup Website',
    description: 'Next.js-based responsive business website featuring performance-optimized components.',
    image: '/lovable-uploads/dostartup-1.webp',
    ...
    demoMedia: [
      ...
      { type: 'image', url: '/lovable-uploads/dostartup-5.webp' },
      { type: 'image', url: '/lovable-uploads/dostartup-6.webp' },
    ]
  },
  {
    title: 'Sahayak',
    description: 'Android app for real-time hospital appointment and bed booking.',
    image: '/lovable-uploads/sahayak-1.webp',
    ...
    demoMedia: [
      ...
      { type: 'image', url: '/lovable-uploads/sahayak-4.webp' },
      { type: 'image', url: '/lovable-uploads/sahayak-5.webp' },
      { type: 'image', url: '/lovable-uploads/sahayak-8.webp' },
      { type: 'image', url: '/lovable-uploads/sahayak-7.webp' },
  ...
  },
  {
    ...
    image: '/lovable-uploads/puzzle-2.webp',
    technologies: ['Flutter', 'Dart', 'UI/UX Design', 'RestAPI', 'AWS', 'Node.js', 'Express.js'],
    status: 'Completed',
    ...
    demoMedia: [
      ...
      { type: 'image', url: '/lovable-uploads/puzzle-5.webp' },
      { type: 'image', url: '/lovable-uploads/puzzle-6.webp' },
    ]
  },
  {
    ...
    image: '/lovable-uploads/fund-1.webp',
    ...
    demoMedia: [
      ...
      { type: 'image', url: '/lovable-uploads/fund-5.webp' },
      { type: 'image', url: '/lovable-uploads/fund-6.webp' },
      { type: 'image', url: '/lovable-uploads/fund-7.webp' },
      { type: 'image', url: '/lovable-uploads/fund-8.webp' },    
    ]
  },
  {
